...
def main():
    ...
    # in this case, PUT created a 'file' called '/requests', with a 'vaule' of 'http for humans'
    ...
    # issue an HTTP PUT transaction to store our data within /keys/requests
    # in this case, PUT updated a 'file' called '/requests', with a 'vaule' of 'http for humans'
    # r is the response code resulting from the PUT
